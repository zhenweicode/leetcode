...
- [38.外观数列](2.题目/38.外观数列.md)
- [118.杨辉三角](2.题目/118.杨辉三角.md)
- [168.Excel表列名称(进制转换)](2.题目/168.Excel表列名称(进制转换).md)
- [169.多数元素(众数)](2.题目/169.多数元素(众数).md)
- [172.阶乘后的零](2.题目/172.阶乘后的零.md)
- [189.旋转数组](2.题目/189.旋转数组.md)
- [204.计数质数](2.题目/204.计数质数.md)
- [243.最短单词距离](2.题目/243.最短单词距离.md)
- [283.移动零](2.题目/283.移动零.md)
- [443.压缩字符串](2.题目/443.压缩字符串.md)
- [645.错误的集合](2.题目/645.错误的集合.md)
- [836.矩形重叠](2.题目/836.矩形重叠.md)
...
- [273.整数转换英文表示](2.题目/273.整数转换英文表示.md)
...
- [116.填充每个节点的下一个右侧节点指针](2.题目/116.填充每个节点的下一个右侧节点指针.md)
...
- [230.二叉搜索树的第k大节点](2.题目/230.二叉搜索树的第k大节点.md)
...
- [450.删除二叉搜索树中的节点](2.题目/450.删除二叉搜索树中的节点.md)
- [543.二叉树的直径](2.题目/543.二叉树的直径.md)
- [572.另一个树的子树](2.题目/572.另一个树的子树.md)
- [1372.二叉树中的最长交错路径](2.题目/1372.二叉树中的最长交错路径.md)


# 动态规划和递归
[链接](1.基础/1.解题框架/动态规划子目录/动态规划.md)
- 2.1 计算二项式系数
- 2.2 矩阵的最小路径和⭐
- 2.3 换钱的最少货币数
- 2.4 换钱的方法数⭐
...
- [73.矩阵置零](2.题目/73.矩阵置零.md)
- [221.最大正方形](2.题目/221.最大正方形.md)
- [238.构建乘积数组](2.题目/238.构建乘积数组.md)
- [240.搜索二维矩阵II](2.题目/240.搜索二维矩阵II.md)
- [378.有序矩阵中第K小的元素](2.题目/378.有序矩阵中第K小的元素.md)
...
- [1239.串联字符串的最大长度](2.题目/1239.串联字符串的最大长度.md)
...
- [380.常数时间插入删除和获取随机元素](2.题目/380.常数时间插入删除和获取随机元素.md)
- [706.设计哈希映射](2.题目/706.设计哈希映射.md)
